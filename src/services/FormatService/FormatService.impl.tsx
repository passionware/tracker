...
function DayBadge({ value }: { value: ReactNode }) {
  return (
    <span className="pr-2 last:pr-1 bg-emerald-100 text-emerald-700 border border-black/[0.16] px-0.5 rounded">
      {value}
    </span>
  );
}
...
function MonthBadge({ value }: { value: ReactNode }) {
  return (
    <span className="pr-2 last:pr-1 bg-sky-100 text-sky-700 border border-black/[0.16] px-0.5 rounded">
      {value}
    </span>
  );
}
...
function YearBadge({ value }: { value: ReactNode }) {
  return (
    <span className="pr-2 last:pr-0.5 bg-purple-100 text-purple-700 border border-black/[0.16] px-0.5 rounded">
      {value}
    </span>
  );
}
