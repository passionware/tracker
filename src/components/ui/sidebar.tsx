...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-popover isolate min-w-0 max-w-full overflow-x-hidden",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden with-styled-scrollbars",
        className,
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  [
    "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding,background] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50",
    "group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50",
    "data-[active=true]:data-[state=closed]:bg-sidebar-accent data-[active=true]:data-[state=closed]:text-sidebar-accent-foreground data-[state=open]:data-[state=closed]:hover:bg-sidebar-accent data-[state=open]:data-[state=closed]:hover:text-sidebar-accent-foreground",
