...
export function Dashboard(props: DashboardProps) {
  return (
    ...
    >
      <div>Dashboard</div>
      <div className="p-10 text-3xl text-white/50 grid grid-flow-col items-stretch justify-stretch justify-items-stretch *:w-full *:aspect-square gap-24 *:flex *:items-center *:justify-center">
        <Link
