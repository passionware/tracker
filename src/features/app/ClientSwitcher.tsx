      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              className="rounded-xl py-7 border border-sky-900/10 dark:border-sky-900/50  bg-linear-to-tl from-rose-300/5 to-blue-500/5 dark:from-rose-300/15 dark:to-blue-500/15 outline-hidden focus-visible:ring-2 focus:ring-rose-500/20"
            >
              {activeItem ? (
