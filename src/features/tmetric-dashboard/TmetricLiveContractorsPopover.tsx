...
/** Matches collapsed `ContractorRow` chrome height (padding + text-sm leading-5 + two 11px lines). */
const contractorRowCardMinClass = "min-h-[5rem]";

/** Mirrors `ContractorRow` layout (card, chevron, three text lines, Copy). */
      ...
      <SidebarMenuItem>
        ...
        >
          ...
          >
            ...
            <div
              className="max-h-[min(70vh,30rem)] overflow-y-auto bg-background/50 px-3 py-3"
