 ...
 */
export const TimelineMilestoneDiamond = forwardRef(function TimelineMilestoneDiamond<
  Data = unknown,
>(
  {
    item,
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isHovered && !isSelected && !selected && "ring-1 ring-foreground/40",
      )}
      style={{
        left,
        top,
...
TimelineMilestoneDiamond.displayName = "TimelineMilestoneDiamond";
