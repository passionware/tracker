...
export function CommonPageContainer(
  ...
  return (
    <>
      <header className="sticky top-0 bg-white z-10 shadow-sm flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
